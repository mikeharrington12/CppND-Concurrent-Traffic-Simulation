...
void TrafficLight::cycleThroughPhases()
{
    ...
    // Random number generator used to cycle the light
    ...
    while(true)
    {
        ...
        std::chrono::duration<double> elapsed_time = loop_time - start_time;
        

        if ( elapsed_time.count() > time_threshold)
        {
            // Change the light phase
            setCurrentPhase();
